...
import efficientnet.trainer
import efficientnet.datasets.imagenet
import efficientnet.optim
import efficientnet.models.efficientnet


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('-c', '--config', type=str, default='configs/animals.yaml')
...
def main():
    ...
    trainer = mlconfig.instantiate(config.trainer, model, optimizer, train_loader, valid_loader, scheduler, device)
